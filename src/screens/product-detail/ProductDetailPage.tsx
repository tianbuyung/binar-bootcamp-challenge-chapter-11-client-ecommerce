...
const ProductDetailPage = ({ query }: ProductDetailProps) => {
		...
		<div>
			...
			<Container>
				...
				{!loading ? (
					...
					<Row xs={1} md={2} className="align-items-center">
						<Col>
							<Image width="400" height="400" src={NO_IMAGE} alt="gambar" />
						</Col>
						<Col style={{ textAlign: "left" }}>
							<Placeholder as="h2" animation="glow">
								<Placeholder lg={12} size="lg" />
							...
							<Placeholder as="h3" animation="glow">
								<Placeholder lg={2} /> <Placeholder lg={1} bg="secondary" />{" "}
								<Placeholder lg={1} bg="info" />
							</Placeholder>
						</Col>
					</Row>
				)}
